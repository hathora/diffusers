...
def triton_(arg_A, arg_B, in_ptr2, out_ptr1, ks0):
    ...
    tl.store(out_ptr1 + (tl.broadcast_to(idx_n + (12288*idx_m), acc.shape)), tmp16, mask)


def get_args():
    arg_0 = rand_strided((1, 512, 3072), (1572864, 3072, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((12288, 3072), (3072, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_2 = rand_strided((12288,), (1,), device='cuda:0', dtype=torch.bfloat16)
    arg_3 = rand_strided((1, 512, 12288), (6291456, 12288, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_4 = 512
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_.run(*args, grid=(384, 1, 1), stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_.benchmark_all_configs(*args, grid=(384, 1, 1))
