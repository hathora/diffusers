...
def get_args():
    ...
    arg_1 = rand_strided((3072, 256), (256, 1), device='cuda:0', dtype=torch.bfloat16)
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_.run(*args, grid=(48, 1, 1), stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_.benchmark_all_configs(*args, grid=(48, 1, 1))
