...
def get_args():
    arg_0 = rand_strided((1, 4608, 3072), (14155776, 3072, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((1, 4608, 3072), (14155776, 3072, 1), device='cuda:0', dtype=torch.bfloat16)
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_.run(*args, 14155776, grid=grid(14155776), stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_.benchmark_all_configs(*args, 14155776, grid=grid(14155776))
